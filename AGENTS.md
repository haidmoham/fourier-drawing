...
Preserve intentional lowercase in authored interface copy. Do not normalize capitalization unless the user asks.

Use `fourier-drawing` as the canonical project slug. Use lowercase kebab-case for the repository, local directory, package, and hosted project names.
